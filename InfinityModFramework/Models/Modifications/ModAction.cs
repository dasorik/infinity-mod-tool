...
using InfinityModFramework.Extension;
...
namespace InfinityModFramework.Models
{
	...
	{
		public readonly ModInstallationInfo mod;
		public readonly T action;

		public ModAction(ModInstallationInfo mod, T action)
		{
			this.mod = mod;
			this.action = action;
		}
	...
	public class ModActionCollection
	{
		...
		public void AddActionsFromMod(ModInstallationInfo mod)
		{
			var installActions = mod.Config.InstallActions ?? new ModInstallAction[] { };
			AddActions(mod, installActions);
		}

		public void AddActions(ModInstallationInfo mod, ModInstallAction[] actions)
		{
		...
		public ModActionCollection CreateFilteredCollection(ModInstallationInfo mod, bool filterOut = false)
		{
		...
		private bool Filter<TAction>(ModAction<TAction> action, ModInstallationInfo mod, bool filterOut = false)
		{
