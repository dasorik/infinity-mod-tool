...
namespace InfinityModFramework.Utilities
{
	public class ModCollisionTracker
	{
		...
		public static bool HasMoveCollision(ModInstallationInfo currentMod, string file, string destinationPath, List<FileModification> modifications, out ModCollision collision)
		{
		...
		public static bool HasCopyCollision(ModInstallationInfo currentMod, string file, string destinationPath, List<FileModification> modifications, out ModCollision collision)
		{
			var actions = new ActionCollection(file, currentMod.Config.ModID, modifications);
			var destinationActions = new ActionCollection(destinationPath, currentMod.Config.ModID, modifications);
		...
		public static bool HasReplaceCollision(ModInstallationInfo currentMod, string file, string replacementFile, List<FileModification> modifications, out ModCollision collision)
		{
			var actions = new ActionCollection(file, currentMod.Config.ModID, modifications);
		...
		public static bool HasEditCollision(ModInstallationInfo currentMod, string file, IWriteContent content, FileWriterUtility fileWriter, List<FileModification> modifications, out ModCollision collision)
		{
			var actions = new ActionCollection(file, currentMod.Config.ModID, modifications);
		...
		private static bool AddModCollision(ModInstallationInfo mod, ModInstallActionEnum action, FileModificationType collisionReason, string collidingModID, ModCollisionSeverity severity, out ModCollision collision, string suffix = "")
		{
		...
		private static bool AddModCollision(ModInstallationInfo mod, string actionDescription, FileModificationType collisionReason, string collidingModID, ModCollisionSeverity severity, out ModCollision collision, string suffix = "")
		{
			string collisionReasonDescription = GetCollisionDescription(collisionReason);
			return AddModCollision(mod, actionDescription, collisionReasonDescription, collidingModID, severity, out collision, suffix: suffix);
		}

		private static bool AddModCollision(ModInstallationInfo mod, ModInstallActionEnum action, string collisionReasonDescription, string collidingModID, ModCollisionSeverity severity, out ModCollision collision, string suffix = "")
		{
			string actionDescription = GetModificationDescription(action);
			return AddModCollision(mod, actionDescription, collisionReasonDescription, collidingModID, severity, out collision, suffix: suffix);
		}

		private static bool AddModCollision(ModInstallationInfo mod, string actionDescription, string collisionReasonDescription, string collidingModID, ModCollisionSeverity severity, out ModCollision collision, string suffix = "")
		{
