...
namespace InfinityModEngine
{
	public class ModCollisionTracker
	{
		...
		public static bool HasEditCollision(ModInstallationInfo currentMod, string file, IWriteContent content, FileWriter fileWriter, List<FileModification> modifications, out ModCollision collision)
		{
			var actions = new ActionCollection(file, currentMod.Config.ModID, modifications);
